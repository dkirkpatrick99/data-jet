// Custom object search for returning an array of objects that match a key string
 ...
 * @param {Object} options - options for the match
...
/**
 * Prepares value for comparison by stringifying it
